        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-secondary-100 dark:hover:text-primary-400 transition-colors"
                  >
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="blank"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-primary-100 dark:hover:bg-primary-900/70 transition-all duration-300 transform hover:scale-110"
                >
          ...
          <div className="bg-white dark:bg-gray-700 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full sm:w-auto px-6 py-3 bg-secondary-100 hover:bg-secondary-200 text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] flex items-center cursor-pointer justify-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <details className="group border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-primary-500 dark:hover:border-primary-400 transition-colors duration-300">
              ...
              <div className="mt-3 text-gray-600 dark:text-gray-400">
                ...
                responsive websites, web applications, and mobile app
            ...
            <details className="group border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-primary-500 dark:hover:border-primary-400 transition-colors duration-300">
              ...
              <div className="mt-3 text-gray-600 dark:text-gray-400">
                My process typically involves discovery, planning, design,
                development, testing, and deployment phases. I believe in an
                iterative approach with regular client feedback throughout the
                project lifecycle.
              </div>
            </details>
            ...
            <details className="group border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-primary-500 dark:hover:border-primary-400 transition-colors duration-300">
              ...
              <div className="mt-3 text-gray-600 dark:text-gray-400">
                ...
                could take 2-6 months. I'll provide a detailed timeline during
            ...
            <details className="group border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-primary-500 dark:hover:border-primary-400 transition-colors duration-300">
              ...
              <div className="mt-3 text-gray-600 dark:text-gray-400">
                Yes, I offer various maintenance and support packages to ensure
                your project continues to run smoothly after launch. This
                includes updates, bug fixes, and performance optimization.
              </div>
            </details>
          </div>
        </div>
